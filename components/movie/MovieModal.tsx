...
export function MovieModal({
  ...
  // FIX #1: useBodyScrollLock hook ашиглав — overflow conflict арилгасан
          ...
          {similar.length > 0 && (
            <>
              ...
              <div className="similar-grid">
                {similar.map((m) => (
                  // FIX #2: onPlay(m) → onInfo(m): similar кино дарахад
                  // шууд тоглуулахын оронд тухайн киноны modal нээнэ
                  <div
                    key={m.id}
