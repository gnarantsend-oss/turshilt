...
export function MovieModal({ movie, onClose, onPlay, myList, onToggleList }: {
    ...
    >
      ...
      >
        <div className="modal-banner">
          {img && (
            <motion.div layoutId={`movie-img-${movie.id}`}
        ...
        <div className="modal-content">
          ...
          <div className="modal-actions">
            ...
            <button className="btn-circle" onClick={() => onToggleList(movie)}
